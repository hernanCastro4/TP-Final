        ...
        <section class="full-box dashboard-contentPage">
            ...
            <div class="container-fluid">
                <div class="page-header">
                    <h1 class="text-titles">Editar Clientes</h1>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-10 col-md-offset-1">
                                            <form action="svEditarCliente" method="get">
                                                ...
                                                <p>Apellido</p>
                                                <div class="form-group label-floating">
                                                    <input class="form-control" type="text" name="apellido" value="<%=cli.getApellido()%>">
                                                </div>
                                                <p>Dni</p>
                                                <div class="form-group label-floating">
                                                ...
                                                <p>Nacionalidad</p>
                                                <div class="form-group label-floating">
                                                    <input class="form-control" type="text" name="nacionalidad" value="<%=cli.getNacionalidad()%>">
                                                </div>
                                                ...
                                                <p>Celular</p>
                                                <div class="form-group label-floating">
                                                    <input class="form-control" type="text" name="celular" value="<%=cli.getCelular()%>">
                                                </div>
                                                
                                                <p>Email</p>
                                                <div class="form-group label-floating">
                                                    <input class="form-control" type="text" name="email" value="<%=cli.getEmail()%>">
                                                </div>
