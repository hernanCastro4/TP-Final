    ...
    public void create(Servicio servicio) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Paquete paquetesPaqueteToAttach : servicio.getPaquetes()) {
                paquetesPaqueteToAttach = em.getReference(paquetesPaqueteToAttach.getClass(), paquetesPaqueteToAttach.getCodigo_paquete());
    ...
    public void edit(Servicio servicio) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Paquete paquetesNewPaqueteToAttach : paquetesNew) {
                paquetesNewPaqueteToAttach = em.getReference(paquetesNewPaqueteToAttach.getClass(), paquetesNewPaqueteToAttach.getCodigo_paquete());
